...
namespace Eitan.Sherpa.Onnx.Unity.Editor.Mono
{
    ...
    internal static class SherpaMonoMenuItems
    {
        ...
        [MenuItem(Root + "Speech Enhancement/Speech Enhancer", false, MenuPriority + 5)]
        private static void CreateSpeechEnhancer(MenuCommand command) =>
            CreateWithComponent<SpeechEnhancerComponent>("Speech Enhancer", command);
